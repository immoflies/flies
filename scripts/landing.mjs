...
<header class="site-header shell">
  ...
  <nav aria-label="Main navigation"><a href="#science">Reflex</a><a href="#games">The flies</a><a href="#onchain">On-chain</a><a href="#results">Evidence</a><a class="nav-launch" href="monitor/">Open monitor <span aria-hidden="true">↗</span></a></nav>
</header>
<main id="main">
...
<section class="section shell onchain" id="onchain" aria-labelledby="onchain-title">
  ...
  <dl class="token-card">
    ...
    <div><dt>PAIRED</dt><dd>GOOGL</dd></div>
